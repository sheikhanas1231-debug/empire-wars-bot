...
def calculate_business_cost(business_id, count):
    """Calculate cost of next business purchase"""
...
def main():
    ...
    if not TOKEN:
        ...
        print("Please set your bot token in Render dashboard.")
        return
